...
def convert_prozora_string_to_common_string(string):
	...
	u"Аукціон: прийом пропозицій": "active.auction.dutch",
	u"Аукціон: закриті пропозиції": "active.auction.sealedbid",
	u"Аукціон: цінова пропозиція": "active.auction.bestbid",
        u"Кваліфікація": "active.qualification",
        u"Розглянуто": "active.awarded",
        u"Завершений": "complete",
        u"грн": "UAH",
	u"Переможець голандської частини": "dutch_winner",
	u"Недійсна": "invalid",
	u"Недійсний": "invalid",
